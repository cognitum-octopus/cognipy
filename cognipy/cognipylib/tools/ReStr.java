...
public class ReStr extends Regex
{
	public ReStr()
	{
	}
	public ReStr(TokensGen tks, String str)
	{
		...
		{
			tks.m_tokens.UsingChar(str.charAt(i));
		}
	}
	...
	{
		s.Write(String.format("(\"%1$s\")",m_str));
	}
	@Override
	public int Match(String str, int pos, int max)
	{
		...
		for (j = 0;j < n;j++)
		{
			if (str.charAt(j) != m_str.charAt(j))
			{
				return -1;
			}
		}
